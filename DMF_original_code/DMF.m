...
connectionmatrixpath = '/Users/dipanjanroy/Documents/DRCodes2013/Node_model_RS/BOLD_BALANCE_MODEL_REST/SC_FC_all/';
weights_FC = load([connectionmatrixpath,'Haggman_FC.mat']);
%weights_FC = load([connectionmatrixpath, 'RQ_20120917_fMRI_new.mat']);
FC_emp = weights_FC.FC_emp(1:66,1:66);
